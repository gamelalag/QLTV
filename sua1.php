...
$sua1_sql = "SELECT * FROM danhsachbandoc WHERE masv = $masv";
...
<body>
    <div class="container">
        <h1 style="color:brown">Sửa bạn đọc</h1>
        <form action="update1.php" method="post">
            ...
            <button type="submit" class="btn btn-primary">Sửa bạn đọc</button>
        </form>
    </div>
</body>
